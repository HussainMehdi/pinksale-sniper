...
import type { Pinksaleabi, PinksaleabiInterface } from "../Pinksaleabi";
...
export class Pinksaleabi__factory {
  static readonly abi = _abi;
  static createInterface(): PinksaleabiInterface {
    return new utils.Interface(_abi) as PinksaleabiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Pinksaleabi {
    return new Contract(address, _abi, signerOrProvider) as Pinksaleabi;
  }
}
